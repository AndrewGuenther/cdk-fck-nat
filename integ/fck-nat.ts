...
import { IConnectable, InstanceType, NatProvider } from '@aws-cdk/aws-ec2'
...
const natInstanceProviders: Array<NatProvider & IConnectable> = []
...
natInstanceProviders.push(...getNatInstanceProviders(amiOwner, new InstanceType(arm64InstanceType), arm64AmiNames))
natInstanceProviders.push(...getNatInstanceProviders(amiOwner, new InstanceType(x86InstanceType), x86AmiNames))
